...
istream &operator >> (istream& in, Bookrecord& b){
   return in >> b.nom >> b.montant;
}

ostream &operator << (ostream& os, const Bookrecord& b) {
    return os << "Bookrecord {nom=" << b.nom << ", montant=" << b.montant << "}"; 
}
